    ...
    <main className="legalPage">
      ...
      <article className="container legalContent">
        ...
        <div className="legalContactBox">
          ...
          <p>يمكنك مراسلتنا على <a href="mailto:hello@sukoon-spa.com">hello@sukoon-spa.com</a> أو التواصل عبر واتساب على <a href="https://wa.me/xxxxxxxxxxxxxx" target="_blank" rel="noreferrer" dir="ltr">+966 50 000 0000</a>.</p>
        </div>
      </article>
      <Footer />
    </main>
